...
var apiKey = 'VE_AkQ.2ikRmw:vFw0Pnwy1NRjL0vr_f74g1ZH--dBNRgJKS_jUxl669I'
...
function renderMembers() {
    ...
    for (var index = 0; index < membersList.length; index++) {
        ...
        if (element.clientId !== clientId) {
            html += '<li><small>' + element.clientId + ' <button class="btn btn-xs btn-success" onclick=call("' + element.clientId + '")>connect</button> </small></li>'
        }
    }
    list.innerHTML = html
}
